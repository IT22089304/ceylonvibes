...
const Appointment = () => {
  ...
  return (
    <div className="bg-green-100 p-6 rounded-lg shadow-md mb-8 ">
      <h4 className="text-3xl font-mono antialiased text-gray-800 mb-2 font-weight: 700 line-height: 2rem flex flex-col items-center">
        ...
        <div className="mb-4">
          ...
          <div className="flex">
            ...
            <input
             ...
             <Link to="/service-confirm"> {/* Link to the Service Confirmation */}
