  ...
  return (
    <div className="spa-menu p-12 max-w-7.5xl mx-auto text-center bg-yellow-100">
      ...
      <h3 className="text-2xl text-gray-800 mb-12 line-height-2rem">
        Explore the menu of our Ceylon Vibes SPA in Kandy to discover the treatment that best suits you
      </h3>
      ...
      <div className="flex justify-center spa-categories grid grid-cols-2 gap-8">
